...
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and us, concerning your access to and use of the Sakurako Bot as well as any other media form, website, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Bot”). You agree that by accessing the Bot, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE BOT AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
- Copy or adapt the Bot’s software, including but not limited to Python, JavaScript, or other code.
...
You and the Bot agree that we may access, store, process, and use any information and personal data that you provide following the terms of the [Privacy Policy](https://github.com/dat7726/Sakurako-bot/blob/main/Privacy.md) and your choices (including settings).
...
We care about data privacy and security. Please review our [Privacy Policy](https://github.com/dat7726/Sakurako-bot/blob/main/Privacy.md) . By using the Bot, you agree to be bound by our [Privacy Policy](https://github.com/dat7726/Sakurako-bot/blob/main/Privacy.md), which is incorporated into these Terms of Use. Please be advised the Bot is hosted in the US. If you access the Bot from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the US, then through your continued use of the Bot, you are transferring your data to the US, and you agree to have your data transferred to and processed in the US. Further, we do not knowingly accept, request, or solicit information from children or knowingly market to children. Therefore, in accordance with the US. Children’s Online Privacy Protection Act, if we receive actual knowledge that anyone under the age of 13 has provided personal information to us without the requisite and verifiable parental consent, we will delete that information from the Bot as quickly as is reasonably practical.
...
These conditions are governed by and interpreted following the laws of Vietnam, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence.
...
- Discord: DM `dat#4727` or join the [support server](https://discord.gg/kdKH6n66Qg)
